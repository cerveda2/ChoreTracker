...
core/
  ...
  reminders/                  WorkManager-based chore-overdue reminder (self-contained, see backlog #7)
...
8. ~~**Chore reminders**~~ — Done. See Feature Backlog item 7 above (implemented together as one feature).
